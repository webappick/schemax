...
class AdminEnqueueCest {
	...
	function enqueue_admin_scripts(AcceptanceTester $I) {
		...
		$I->amOnPage('/wp-admin/admin.php?page=schemax');
		$I->seeInPageSource('schemax-settings-script');
		$I->seeInPageSource('schemax-admin-script');
	}

	function enqueue_admin_styles(AcceptanceTester $I) {
		$I->wantTo('access to the plugin settings page and check the style enqueue');
		$I->amOnPage('/wp-admin/admin.php?page=schemax');
		$I->seeInPageSource('schemax-settings-styles-css');
		$I->seeInPageSource('schemax-admin-styles-css');
	}
